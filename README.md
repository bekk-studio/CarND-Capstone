# Programming a Real Self-Driving Car in ROS environment

This is the project repo for the final project of the Udacity Self-Driving Car Nanodegree: Programming a Real Self-Driving Car. For more information about the project, see the project introduction [here](https://classroom.udacity.com/nanodegrees/nd013/parts/6047fe34-d93c-4f50-8336-b70ef10cb4b2/modules/e1a23b06-329a-4684-a717-ad476f0d8dff/lessons/462c933d-9f24-42d3-8bdc-a08a5fc866e4/concepts/5ab4b122-83e6-436d-850f-9f4d26627fd9).

The system goals are:
* control the car in order to follow a trajectory
* stop to the red traffic light by video detection  
...
![diagram](imgs/final-project-ros-graph-v2.png)

## Results on Simulator

![video1](imgs/video1.gif)

![video2](imgs/video2.gif)

![video3](imgs/video3.gif)
